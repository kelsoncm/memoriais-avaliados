      ...
      <table class="data-table">
        ...
        <tbody>
          <tr>
            <td><code>campus</code></td>
            <td>String</td>
            <td>Nome do Campus ou grupo consolidado (<em>Outros Campi agrupados por n &lt; 5</em>).</td>
          </tr>
          <tr>
            <td><code>tipo_campus</code></td>
            <td>String</td>
            <td>Classificação territorial da unidade.</td>
          </tr>
          <tr>
            <td><code>ano</code> / <code>mes</code></td>
            <td>Integer</td>
            <td>Período temporal da agregação.</td>
          </tr>
          <tr>
            <td><code>total_processos</code></td>
            <td>Integer</td>
            <td>Número total de processos avaliados no grupo ($n \ge 5$).</td>
          </tr>
          <tr>
            <td><code>total_deferidos</code></td>
            <td>Integer</td>
            <td>Total de processos aprovados com êxito.</td>
          </tr>
          <tr>
            <td><code>taxa_deferimento</code></td>
            <td>Float (%)</td>
            <td>Percentual de aprovação no campus/período.</td>
          </tr>
          <tr>
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr>
            <td><code>cargo</code></td>
            <td>String</td>
            <td>Cargo no PCCTAE.</td>
          </tr>
          <tr>
            <td><code>classe_cargo</code></td>
            <td>String</td>
            <td>Classe funcional no plano de carreira (C, D, E).</td>
          </tr>
          <tr>
            <td><code>nivel_pretendido</code></td>
            <td>String</td>
            <td>Nível de RSC pretendido pelo servidor.</td>
          </tr>
          <tr>
            <td><code>total_processos</code></td>
            <td>Integer</td>
            <td>Total de memoriais submetidos e avaliados.</td>
          </tr>
          <tr>
            <td><code>taxa_deferimento</code></td>
            <td>Float (%)</td>
            <td>Percentual de concessão.</td>
          </tr>
        </tbody>
      </table>

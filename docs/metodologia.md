...
<div class="content-container">
  <div class="doc-wrapper">
    <article class="doc-article">
      ...
      <ul>
        <li>
          <strong>Taxa de Cobertura Global (%):</strong>
          $$\text{Cobertura Global} = \left( \frac{\text{Total de Memoriais Avaliados}}{\text{Total de TAEs Ativos no IFRN}} \right) \times 100$$
        </li>
        <li>
          <strong>Taxa de Adesão por Campus / Cargo (%):</strong>
          $$\text{Taxa de Adesão} = \left( \frac{\text{Memoriais Avaliados na Unidade ou Carreira}}{\text{TAEs Ativos na Unidade ou Carreira}} \right) \times 100$$
        </li>
        <li>
